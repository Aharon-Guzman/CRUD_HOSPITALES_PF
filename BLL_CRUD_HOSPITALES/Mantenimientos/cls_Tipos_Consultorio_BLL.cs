...
{
    public class cls_Tipos_Consultorio_BLL
    {
        /// <summary>
        /// Método que ejecuta LISTAR o FILTRAR según los parámetros recibidos
        /// </summary>
        public void listarFiltrarTipos_Consultorio(ref cls_Tipos_Consultorio_DAL obj_Tipos_Consultorio_DAL)
        {
            try
            {
                ...
                //Listar
                if (
                    ((obj_Tipos_Consultorio_DAL.sTipo_Consultorio == string.Empty) || (obj_Tipos_Consultorio_DAL.sTipo_Consultorio == null))
                    &&
                    ((obj_Tipos_Consultorio_DAL.sEstado == string.Empty) || (obj_Tipos_Consultorio_DAL.sEstado == null))
                )
                {
                    //Definimos el nombre del Key que contiene el valor del procedimiento almacenado
                    obj_BD_DAL.sNomSP = ConfigurationManager.AppSettings["SP_LST_Tipos_Consultorio"];
                    obj_BD_DAL.DT_Parametros = null;
                    //Definimos un nombre lógico del data table de respuesta
                    obj_BD_DAL.sNomTabla = "Tipos_Consultorio";
                }
                else //Filtrar
                {
                    /*Dar forma al atributo de Data Table de Parámetros*/
                    obj_Tipos_Consultorio_DAL.dtParametros = null;
                    ...
                    //Definimos el SP
                    obj_BD_DAL.sNomSP = ConfigurationManager.AppSettings["SP_FIL_Tipos_Consultorio"];
                    obj_BD_DAL.DT_Parametros = obj_Tipos_Consultorio_DAL.dtParametros;
                    obj_BD_DAL.sNomTabla = "Tipos_Consultorio";
                }
                ...
                {
                    obj_Tipos_Consultorio_DAL.dtDatos = obj_BD_DAL.DS.Tables[0];
                }
                else
                {
                    obj_Tipos_Consultorio_DAL.dtDatos = null;
                }
            }
            catch (Exception ex)
            {
        ...
        public void Obtiene_Informacion_Tipos_Consultorio(ref cls_Tipos_Consultorio_DAL obj_Tipos_Consultorio_DAL)
        {
            try
            {
                /*Objetos para comunicación a la base de datos*/
        ...
        public void crearTipos_Consultorio(ref cls_Tipos_Consultorio_DAL obj_Tipos_Consultorio_DAL)
        {
            try
            {
                ...
                //Definir SP
                obj_BD_DAL.sNomSP = ConfigurationManager.AppSettings["SP_Insert_Tipos_Consultorio"];
                ...
                if (obj_BD_DAL.sMsjErrorBD == string.Empty)
                {
                    obj_Tipos_Consultorio_DAL.sMSJError = obj_BD_DAL.sMsjErrorBD;
                    obj_Tipos_Consultorio_DAL.sValorScalar = obj_BD_DAL.sValorScalar;
                }
                else
                {
                    obj_Tipos_Consultorio_DAL.sMSJError = obj_BD_DAL.sMsjErrorBD;
                    obj_Tipos_Consultorio_DAL.sValorScalar = null;
                }
            }
            catch (Exception ex)
            {
        ...
        public void modificarTipos_Consultorio(ref cls_Tipos_Consultorio_DAL obj_Tipos_Consultorio_DAL)
        {
            try
            {
                ...
                //Definir SP
                obj_BD_DAL.sNomSP = ConfigurationManager.AppSettings["SP_Update_Tipos_Consultorio"];
        ...
        public void eliminarTipos_Consultorio(ref cls_Tipos_Consultorio_DAL obj_Tipos_Consultorio_DAL)
        {
            try
            {
                ...
                //Definir SP
                obj_BD_DAL.sNomSP = ConfigurationManager.AppSettings["SP_Delete_Tipos_Consultorio"];
                obj_BD_DAL.sIndAxn = "SCALAR";
                obj_BD_DAL.DT_Parametros = obj_Tipos_Consultorio_DAL.dtParametros;
